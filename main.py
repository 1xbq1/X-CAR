...
def init_parameters():
    ...
    parser.add_argument('--seminum', '-sem', type=int, default=0, help='select 5%, 10%, 20% label')
    ...
    parser.add_argument('--byol', '-by', default=False, action='store_true', help='load supcon checkpoint')
